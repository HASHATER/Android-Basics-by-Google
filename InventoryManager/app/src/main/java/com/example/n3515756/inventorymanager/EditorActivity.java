...
/**
 * Created by n3515756 on 4/18/2017.
 */

public class EditorActivity extends AppCompatActivity implements
        LoaderManager.LoaderCallbacks<Cursor> {

    public static final String TAG = ProductEntry.class.getSimpleName();
    ...
    private void saveProduct() {
        ...
        values.put(ProductEntry.COLUMN_PRODUCT_QUANTITY, inventoryString);
        values.put(ProductEntry.COLUMN_PRODUCT_SALE, salesString);
        values.put(ProductEntry.COLUMN_PRODUCT_PRICE, priceString);
        values.put(ProductEntry.COLUMN_PRODUCT_SUPPLIER, supplierString);
        values.put(ProductEntry.COLUMN_PRODUCT_PICTURE, mCurrentPhotoUri);
